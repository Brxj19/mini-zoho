...
class PurchaseOrder(TenantOwnedMixin, TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("ix_purchase_orders_tenant_order_date", "tenant_id", "order_date"),
    )
    ...
    status: Mapped[PurchaseOrderStatusEnum] = mapped_column(
        Enum(PurchaseOrderStatusEnum, name="purchase_order_status_enum"),
        nullable=False,
