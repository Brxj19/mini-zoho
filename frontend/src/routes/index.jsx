...
import { CommercialListPage } from "../pages/CommercialListPage";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "customers", element: <CommercialListPage kind="customers" />, handle: withHandle("Customers", "Sales") },
      ...
      { path: "sales-orders", element: <CommercialListPage kind="salesOrders" />, handle: withHandle("Sales Orders", "Sales") },
      ...
      { path: "packages", element: <CommercialListPage kind="packages" />, handle: withHandle("Packages", "Sales") },
      ...
      { path: "invoices", element: <CommercialListPage kind="invoices" />, handle: withHandle("Invoices", "Sales") },
      ...
      { path: "sales-returns", element: <CommercialListPage kind="salesReturns" />, handle: withHandle("Sales Returns", "Sales") },
      ...
      { path: "vendors", element: <CommercialListPage kind="vendors" />, handle: withHandle("Vendors", "Purchases") },
      ...
      { path: "purchase-orders", element: <CommercialListPage kind="purchaseOrders" />, handle: withHandle("Purchase Orders", "Purchases") },
      ...
      { path: "purchase-receives", element: <CommercialListPage kind="purchaseReceives" />, handle: withHandle("Purchase Receives", "Purchases") },
      ...
      { path: "bills", element: <CommercialListPage kind="bills" />, handle: withHandle("Bills", "Purchases") },
